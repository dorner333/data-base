...
void* hash_open(char* hash_name)
    ...
    if (!strcmp(hash_name,"murmur"))
        {
        hash = murmur3_32;
        }
    else if (!strcmp(hash_name,"Murmur"))
        {
        hash = murmur3_32;
        }
    else if (!strcmp(hash_name,"MURMUR"))
    ...
    else if (!strcmp(hash_name,"murmur3"))
        {
        hash = murmur3_32;
        }
    else if (!strcmp(hash_name,"murmur32"))
        {
        hash = murmur3_32;
        }
